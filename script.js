...
$(document).ready(function () {
  ...
  const APIKEY = "63b6299b969f06502871a984";
  getContacts();
  ...
  $("#contact-submit").on("click", function (e) {
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://idp06-d400.restdb.io/rest/contact",
  ...
  function updateForm(id, contactName, contactEmail, contactMsg) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://idp06-d400.restdb.io/rest/contact/${id}`,//update based on the ID
      "method": "PUT",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": `https://idp06-d400.restdb.io/rest/contact/${id}`,
    "method": "DELETE",
    "headers": {
      "content-type": "application/json",
      "x-apikey": APIKEY,
